    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#00aa33" },
                textPrimary: mode === "light" ? "#00aa33" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#00aa33" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#00aa33" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #00aa33, #008822, ##006611)" : "#666",
