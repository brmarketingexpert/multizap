    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          default: "Padrão",
          sendIdQueue: "Fluxo",
          timeSendQueue: "Redirecionar para o fluxo em X minutos",
          queueRedirection: "Redirecionamento de fluxo",
          queueRedirectionDesc: "Selecione um fluxo para os contatos que não possuem fluxo serem redirecionados",
          prompt: "Prompt",
      ...
      transferTicketModal: {
        ...
        fieldQueueLabel: "Transferir para fluxo",
        fieldQueuePlaceholder: "Selecione um fluxo",
      ...
      mainDrawer: {
        listItems: {
          ...
          connections: "Chips",
          tickets: "Conversas",
          quickMessages: "Respostas Prontas",
          contacts: "Contatos",
          queues: "Fluxos",
          tags: "Tags",
      ...
      queues: {
        ...
        table: {
          ...
          actions: "Ações",
          orderQueue: "Ordenação do fluxo (bot)",
        },
        buttons: {
          add: "Adicionar fluxo",
        },
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! As conversas desse fluxo continuarão existindo, mas não terão mais nenhum fluxo atribuída.",
        },
      },
      queueSelect: {
        inputLabel: "Fluxos",
      ...
      users: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Todos os dados do usuário serão perdidos. Os atendimento abertos deste usuário serão movidos para o fluxo.",
        },
      },
      helps: {
      ...
      backendErrors: {
        ...
        ERR_WAPP_GREETING_REQUIRED:
          "A mensagem de saudação é obrigatória quando há mais de um fluxo.",
      },
    },
  },
};
